 ...
 */
export const getOrCreateNote = async (projectId: number): Promise<SharedNote> => {
 ...
 */
export const updateNoteContent = async (projectId: number, content: string): Promise<SharedNote> => {
